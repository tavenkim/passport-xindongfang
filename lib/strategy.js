...
function Strategy (options, verify) {
  options = options || {}
  options.authorizationURL = options.authorizationURL || options.sandbox ? 'https://testu2.staff.xdf.cn/i/u2e2/index.aspx' : 'https://passport.xdf.cn/i/u2e2/index.aspx'
  options.tokenURL = options.tokenURL || options.sandbox ? 'https://testu2.staff.xdf.cn/apis/oauth.ashx' : 'https://passport.xdf.cn/apis/oauth.ashx'
  ...
  this._userProfileURL = options.userProfileURL || options.sandbox ? 'https://testu2.staff.xdf.cn/apis/oauth.ashx' : 'https://passport.xdf.cn/apis/oauth.ashx'
